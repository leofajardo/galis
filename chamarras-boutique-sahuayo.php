        ...
        <section>
            ...
            <div class="products_list products_slider">
                ...
                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
                    <li> <a class="product_image"><img src="images/blusa-tejido/chamarra-mezcliya.jpg"/></a>
                    ...
                    <li> <a class="product_image"><img src="images/blusa-tejido/chamarra-torerita.jpg"/></a>
                        <div class="product_info">
                            <h3><a href="leisure_detail.html">CN Clogs Beach/Garden Clog</a></h3>
                            <small>Comfortable and fun to wear these clogs are the latest trend in fash</small> </div>
                        <div class="price_info"> <a href="#">+ Ver mas Modelos</a>
                    ...
                    <li> <a class="product_image"><img src="images/blusa-tejido/chamarra-sintetica.jpg"/></a>
                        <div class="product_info">
                            <h3><a href="leisure_detail.html">CN Clogs Beach/Garden Clog</a></h3>
                            <small>Comfortable and fun to wear these clogs are the latest trend in fash</small> </div>
                        <div class="price_info"> <a href="#">+ Ver mas Modelos</a>
